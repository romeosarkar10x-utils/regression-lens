...
>(({ className, children, ...props }, ref) => {
    ...
    return (
        <SelectPrimitive.Value
            ref={ref}
            className={cn(" [&>span]:text-red-500", className)}
            {...props}
        >
            {children}
        </SelectPrimitive.Value>
...
>(({ className, children, ...props }, ref) => (
    <SelectPrimitive.Trigger
        ...
        className={cn(
            ...
            // Focus states
            "ring-offset-background focus:ring-1 focus:ring-ring focus:outline-none",
            // Disabled states
            "disabled:cursor-not-allowed disabled:opacity-50",
            // Child element styles
            "[&>span]:line-clamp-1 [&>span]:text-muted-foreground",
            className,
        )}
        {...props}
    >
