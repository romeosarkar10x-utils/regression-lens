...
function getTypeColor(type: tAssertionType) {
    switch (type) {
        case "cassandra":
...
function getComponent(assertion: tAssertion) {
    switch (assertion.type) {
        case "cassandra":
            return <Cassandra {...assertion} />;
        case "kafka":
            return <Kafka {...assertion} />;
        case "log":
            return <Log {...assertion} />;
    }
}
